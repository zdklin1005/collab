...
/// Tourist's claimed merchant vouchers.
///
/// Used to also show a second "achievement rewards" section for generic
/// vouchers earned from leveling up or completing voucher-type missions
/// (see RewardService.awardVoucher()) — both of those sources are gone
/// now (level-ups no longer grant a voucher, and daily missions no
/// longer generate generic voucher-type missions; only real
/// campaign-tied vouchers exist going forward), so that section was
/// removed rather than left showing a permanently-empty state.
